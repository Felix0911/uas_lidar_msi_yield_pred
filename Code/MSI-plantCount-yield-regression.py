...
def mylassoCV2(X, y, out_name, input_names, selectFtNum = 5, 
    ...
    if selectFtFlag:
        ...
        y_pred = linearFit(X_select, y_np, out_name)
        ...
        linearFit(X_select_clean, y_np, out_name)
...
def trainRegressionModels(file_path, 
    ...
    if trainSW:
        ...
        linearFit(X_select_clean, y, out_name)
        if plotFlag:
            residual = y_pred - y
    ...
    if trainFRgr:
        ...
        y_pred = linearFit(X_select, y, out_name)
        if plotFlag:
            residual = y_pred - y
